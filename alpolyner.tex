...
\title{Active polyNER: Generating Training Data for Scientific Named Entity Extraction with Minimal Human Effort}
...
This process that is otherwise tedious and expensive.
