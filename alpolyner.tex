...
These challenges, which are not unique to polymer science, make it difficult to generate training data as specialized skills are needed to correctly label text.
