...
\logan{Perhaps move the characteristics you mention for polymers to this sentence, make them sound more general, and then say polymers is a perfect case for exploring these challenges. This will make your paper seem less polymer-y from the start}
...
These challenges make it difficult to generate training data as specialized skills are needed to correctly label text.
%\kyle{We've proposed polyner a few times now.. I think likely better to focus on what is new this paper}\roselyne{only once was accepted, except the short paper at BNL and I didn't know it yet for sure when I was writing but I see your point. I'll rephrase and I think we can cite an accepted paper.}.
...
Here, we use approximately labeled candidates and active learning to efficiently obtain more annotations from experts and improve performance.
This process that is otherwise tedious and expensive.\logan{Not sure what "This" refers too}
With under five hours of expert time, polyNER demonstrates discrimination capacity comparable to state-of-the-art chemical NLP toolkit and
