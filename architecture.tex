...
we attempt to boost the number of polymer entities in the first batch of candidates to be annotated by using word vector similarity metrics between candidates and commonly used known entities, 
as observed in a subset of publications or as suggested by experts.
