...
%In other words, extracting a higher number of targets potentially requiring additional curation is favored over obtaining fewer correct targets.''}\roselyne{The text is correct}

%\ian{I suspect that I have not got my rounds quite right in the preceding sentence.}\roselyne{that's right, we train with labels selected from the previous round}
