...
\kyle{Could be a clearer description of semi-supervised learning}\logan{Agreed. The key thing that separates it from other learning is that it uses labeled and unlabeled data}
...
\logan{It sounds like these two categories are mutually exclusive. Do you think so? Can you state what differentiates them explicitly?}
...
\logan{Confusing. If PolyNER is similar to boostrapping, why are are you describing it in the active learning section? I'm generally not sure why this paragraph is in "Related Work"}
