...
a collection of \num{10000} PubMed abstracts with \num{84355} chemical entity mentions labeled manually by expert chemistry literature curators, following annotation guidelines specifically defined for this task~\cite{krallinger2015chemdner}. %\ian{i took the preceding from the conclusion because I feel that we should
%stick all info about CDE and CDE+ in one place. I want to confirm, though, that you trained CDE+ on the CHEMDNER corpus, as written here? Or is this actually a statement about CDE?}\roselyne{This statement is about CDE, we benefit indirectly by using CDE+dictionary+rules}
