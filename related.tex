...
\textit{Data programming}, as used in the Snorkel system\kyle{citation?}, has users define 
...
anything that is here now, but not in the next section, into the next section.}
