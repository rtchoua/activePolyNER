...
\ian{Table says ``most frequent,'' text says ``most common.'' Be consistent.}
...
\hline
 3 &    Three most frequent polymer names & 46.90\% \ \ \ \ \\
\hline
 4 &    Three most frequent polymer names, with acronyms &  47.97\% \ \ \ \ \\
\hline
 5 &    10 most frequent polymer names & 46.47\% \ \ \ \ \\
\hline
 6 &    10 most frequent polymer names, with acronyms & 48.39\% \ \ \ \ \\\hline
\hline
...
\ian{I don't see why it is a result that the expert often presented with nearly identical candidates.}
