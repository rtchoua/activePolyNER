...
In both types of plots, active learning using NLP-filtered candidates outperforms the active learning using distance candidates and approaches rule-based performance.
