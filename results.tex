...
& \multicolumn{3}{c|}{\textbf{Strategies}} \\
 & \textbf{Random} & \textbf{UBS}  & \textbf{Distance UBS}  \\
\hline
...
However in the third iteration of active learning, we notice an increase in precision in UBS as shown in Figure~\ref{fig:rocs_prcs_round4}.
