...
Therefore, we generate a FastText word embedding mode, and use our labeled candidates to associate strings with  word vectors enhanced with character level information.
%to train this different word vectors enhanced with character level information.


Once again, we train a KNN classifier using labeled candidates from the AL2 or active learning using a pool of NLP-filtered candidates (identified as best-performing in previous experiments).
