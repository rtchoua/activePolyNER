...
describe that we are first going to look how the choice of seed entities affects recall}
...
The $\chi$DB corpus included 111 our of 175 $\chi$DB polymers.  \kyle{should one of these not be chi?}
We also scraped CrowDB, which lists some polymers and their properties at \url{http://polymerdatabase.com/} for polymer names.
\kyle{I'm not sure exactly what the following means?  is this we have 295 unique polymers in our 100 docs and only 32 overlap with this db?}
...
\subsubsection{Word Embedding Parameters}
\kyle{This first sentence might be better at the end of previous subsection}
