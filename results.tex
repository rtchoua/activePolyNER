...
We estimate labeling time based on previous experiments~\ref{tchoua2019polyner}.
\roselyne{I think we need to use the time reported in polyNER, I will change the time in the paper accordingly, 
we reporeted 2 hours for 897 labels}
