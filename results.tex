...
We achieve higher recall in both cases and intermediate precision with only $\sim$ ten hours of expert labeling with an additional hour of completing untrained users' reviews of randomly sampled candidates.
