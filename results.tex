...
\caption{PR curve for KNN model trained with active learning labels and word representations enriched with character-level information.\ian{I am curious why the line is straight for recall from 0 to 0.4?}}\label{fig:UBS_prcs_fasttext}
%\end{minipage}
\end{figure}
