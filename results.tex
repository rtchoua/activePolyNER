...
At this point we observe predictive ability and combine all labels (from the three strategies: Random, AL1 and AL2) for training a KNN classifier (most frequently selected classifier during the active learning phase).
...
It is worth noting that with limited training data and based solely on context, the classifiers retreives about one third of the gold standard polymers after about ten hours of expert labeleing.
