...
In the labeling and classification steps,\ian{is this rewording correct? I think that as you say you improve each step,
you should be explicit about what you did to improve in each step.}
...
\ian{It is not clear, I think, whether you are comparing against the regular CDE or the enhanced CDE. Should you compare against both?}
