...
To address these challenges, we have previously designed polyNER~\cite{tchoua2019polyner}, a system for generating training data for scientific NER using semi-supervised and active learning.
...
%\roselyne{Moved this to intro as it is repeated in background bu may be clearer than current text in intro}
