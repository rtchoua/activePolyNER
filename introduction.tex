...
\ian{It seems to me that the preceding two sentences that I added are needed to provide context.
They need to be improved, though.}\roselyne{better?}
...
% approach;
the labels are used to train context-based word vector classifiers. %after each iteration.
